...
function cesitEkle(cesit , yenitat){
 cesit.unshift(yenitat);
 return cesit;
}
...
console.log(ismeGoreCesitCikar(orijinalTatlar, "Kahve"));
...
function ismeGoreFiltrele(tatlar, dizi){
  let yeniTatlar = [];
  for(let i=0; i<tatlar.length; i++){
    if(tatlar[i].includes(dizi))
    {
